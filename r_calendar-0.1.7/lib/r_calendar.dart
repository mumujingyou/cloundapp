...
class RCalendarMarker extends InheritedNotifier<RCalendarController> {
  ...
  static RCalendarMarker of(BuildContext context, {bool nullOk: false}) {
    assert(context != null);
//    final RCalendarMarker inherited =context.dependOnInheritedWidgetOfExactType<RCalendarMarker>();
//    final RCalendarMarker inherited =context.ancestorInheritedElementForWidgetOfExactType(RCalendarMarker());

    final RCalendarMarker inherited  =context.inheritFromWidgetOfExactType(RCalendarMarker);
