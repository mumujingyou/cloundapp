...
//        }
        ...
        List list=controller.data;
        for(int i=0;i<list.length;i++){
          Map map=list[i];
          DateTime dateTime=map["attDate"] as DateTime;
          AttendanceStatus attendanceStatus=map["status"] as AttendanceStatus;
          if(dateTime.day==day){
            if(attendanceStatus==AttendanceStatus.exception){
              types.add(RCalendarType.exception);
            }else if(attendanceStatus==AttendanceStatus.qingjia){
              types.add(RCalendarType.qingjia);
            }else if(attendanceStatus==AttendanceStatus.xiu){
              types.add(RCalendarType.xiu);
            }else{
