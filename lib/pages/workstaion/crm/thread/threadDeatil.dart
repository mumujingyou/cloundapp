...
class ThreadDetail extends StatefulWidget {
  ...
  const ThreadDetail({Key key, this.id, this.type}) : super(key: key);
  @override
...
class ThreadDetailState extends State<ThreadDetail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: createAppBar(
            "线索详情", automaticallyImplyLeading: true, actions:[
            ...
            actions: <Widget>[
              CupertinoActionSheetAction(
                  ...
                  onPressed: () async {
                    ...
                    Navigator.push(context, new MaterialPageRoute(builder: (BuildContext context){
                      return new AddFollow(baseClass: threadModel,);
                    }));
                  },
                  child: Text('写跟进')),
              CupertinoActionSheetAction(
                  onPressed: () async {
                    Navigator.of(cxt).pop();
                    Application.router.navigateTo(context, "${Routes.threadEdit}?id=${threadModel.id}",
                        transition: TransitionType.fadeIn);
                  },
                  child: Text('编辑')),
              CupertinoActionSheetAction(
                  onPressed: () async {
                    Navigator.of(cxt).pop();
                    Navigator.push(context, new MaterialPageRoute(builder: (BuildContext context){
                      return new DepartmentManager(baseClass: threadModel,);
                    },settings:RouteSettings(name: Routes.departmentManager,) ),);
                  },
                  child: Text('转移给他人')),
              CupertinoActionSheetAction(
                  onPressed: () {
                    ...
                    Navigator.push(context, new MaterialPageRoute(builder: (BuildContext context){
                      return new TransformToCustomer(threadModel: threadModel,);
                    }));
                  },
                  child: Text('转成客户')),
            ],
